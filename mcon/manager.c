...
int mongo_manager_connection_deregister(mongo_con_manager *manager, mongo_connection *connection)
{
	return mongo_manager_deregister(manager, &manager->connections, connection->hash, connection, mongo_connection_destroy);
}
